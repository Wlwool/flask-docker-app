...
- `flask_app/templates/home.html`: перенос заголовка внутрь карточки, добавлены иконки и текстовые подписи для чекбоксов.  
- `flask_app/templates/password.html`: добавилен индикатор сложности, кнопка-ссылка создаия нового пароля и обработчик копирования.  
- `flask_app/templates/base.html`: добавлен блок `scripts` для подключения JS снизу шаблонов.